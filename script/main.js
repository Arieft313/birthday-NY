...
window.addEventListener('load', () => {
  ...
  const animationTimeline = () => {
    ...
    tl.to(".container", 0.1, {
      ...
      .to(".idea-1", 1.0, ideaTextTransLeave, "+=3.5")
      ...
      .to(".idea-8", 0.7, ideaTextTransLeave, "+=3.5")
      ...
      .to(".idea-11", 0.7, ideaTextTransLeave, "+=3.5")
      .from(".idea-12", 0.7, ideaTextTrans)
      .to(".idea-12", 0.7, ideaTextTransLeave, "+=3.5")
      // .from(
      //   ".idea-5",
      //   0.7, {
      //     rotationX: 15,
